...
def generate_jobs(n_tasks, n_jobs, m_pre, all_tasks):
    ...
    for i in range(n_tasks):
        ...
        for j in range(length):
            ...
            bcet=random.randrange(1,int(deadline/5)+2)
            wcet=bcet + random.randrange(1,int(deadline/5)+2)
            #generate precedence
...
def main():
    ...
    #random.seed(1) #by-default current system time is used as a seed value
